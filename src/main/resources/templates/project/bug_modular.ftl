<script type="text/javascript" src="/static/js/project/bug_modular.js"></script>
<script type="text/javascript">
    ...
    function gotoBUG1() {
        $('#bug_datagrid').datagrid({
            url:basePath + bugListURL + "?modularid=" + modular_id + "&status=0"
        });
        $("#div_tool_1").show();
        $("#div_tool_2").hide();
        $("#div_tool_3").hide();
    ...
    function gotoBUG2() {
        $('#bug_datagrid').datagrid({
            url:basePath + bugListURL + "?modularid=" + modular_id + "&status=1"
        });
        $("#div_tool_1").hide();
        $("#div_tool_2").show();
        $("#div_tool_3").hide();
    ...
    function gotoBUG3() {
        $('#bug_datagrid').datagrid({
            url:basePath + bugListURL + "?modularid=" + modular_id + "&status=2"
        });
        $("#div_tool_1").hide();
        $("#div_tool_2").hide();
        $("#div_tool_3").show();
    ...
    function gotoBUG4() {
        $('#bug_datagrid').datagrid({
            url:basePath + bugListURL + "?modularid=" + modular_id + "&status=3"
        });
        $("#div_tool_1").hide();
        $("#div_tool_2").hide();
        $("#div_tool_3").hide();
    ...
    function gotoBUG5() {
        $('#bug_datagrid').datagrid({
            url:basePath + bugListURL + "?modularid=" + modular_id + "&status=4"
        });
        $("#div_tool_1").hide();
        $("#div_tool_2").hide();
        $("#div_tool_3").hide();
    ...
    function openBUGAddWindow() {
        ...
        $('#bug_add_modularid').val(bug_params.modularid);
    }
    ...
    function openBUGTestSelector(callback_function){
        var property={
            title:"测试用例",
            dataUrl:"project/test/list?modularid=" + bug_params.modularid,//数据连接
...
<div id="bug_window" class="easyui-window" title="BUG管理"
